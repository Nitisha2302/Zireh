...
new class extends Component {
    ...
    public function setLocale(string $locale)
    {
        ...
        return $this->redirect(url()->previous() ?: route('china.orders.index'), navigate: false);
    }
    ...
    public function logout()
    {
        ...
        if ($admin instanceof Admin) {
            LoginLog::markCurrentSessionLoggedOut($admin, 'china_warehouse', request());

            Log::info('China warehouse staff logged out.', [
                'admin_id' => $admin->id,
        ...
        return $this->redirectRoute('china.login', navigate: true);
    }
};
?>
        ...
        <ul class="navbar-nav flex-row align-items-center ms-md-auto">
            ...
            <li class="nav-item navbar-dropdown dropdown-user dropdown">
                ...
                <ul class="dropdown-menu dropdown-menu-end">
                    ...
                    <li>
                        <a class="dropdown-item" href="{{ route('china.profile') }}">
