...
<div>
    ...
    <aside id="layout-menu" class="layout-menu menu-vertical menu">
        ...
        <ul class="menu-inner py-1">
            ...
            <li class="menu-item {{ request()->routeIs('seller.profile') ? 'active' : '' }}">
                <a href="{{ route('seller.profile') }}" class="menu-link">
                    <i class="menu-icon icon-base ti tabler-user"></i>
                    <div>{{ __('seller.profile') }}</div>
                </a>
            </li>
            ...
            <li class="menu-item">
                <a href="javascript:void(0);" class="menu-link" wire:click="logout">
                    <i class="menu-icon icon-base ti tabler-logout"></i>
                    <div>{{ __('seller.logout') }}</div>
                </a>
            </li>
        </ul>
    </aside>
