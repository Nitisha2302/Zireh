        ...
        <div class="authentication-inner py-6">
            <div class="card">
                <div class="card-body">
                                ...
                                <span class="text-primary">
                                    <svg width="32" height="22" viewBox="0 0 32 22" fill="none"
                                        ...
                                        <path opacity="0.06" fill-rule="evenodd" clip-rule="evenodd"
                                            ...
                                            fill="#161616" />
                                        <path fill-rule="evenodd" clip-rule="evenodd"
                                            d="M7.77295 16.3566L23.6563 0H32V6.88383C32V6.88383 31.8262 9.17836 30.6591 10.4057L19.7824 22H13.6938L7.77295 16.3566Z"
                                            fill="currentColor" />
                                    </svg>
                                </span>
                            </span> --}}
                    ...
                    <h4 class="mb-1">{{ __('admin.admin_login') }}</h4>
                    <p class="mb-6">{{ __('admin.admin_login_description') }}</p>
