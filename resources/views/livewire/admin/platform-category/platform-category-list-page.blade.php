            ...
            <div class="row align-items-center g-3">
                <div class="col-md-4">
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control" placeholder="Search categories..." wire:model.live.debounce.500ms="search">
                    </div>
                </div>
                <div class="col-md-4">
                ...
                <tbody>
                    @forelse ($categories as $category)
                        <tr>
                            ...
                            <td>
                                <div class="d-flex flex-column">
                                    @foreach (['en' => '🇺🇸', 'ru' => '🇷🇺', 'tg' => '🇹🇯'] as $locale => $flag)
                                        <span class="{{ $loop->first ? 'fw-semibold text-dark' : 'text-body-secondary' }} {{ $loop->first ? '' : 'small' }}">
                            ...
                            <td>
                                <span class="badge bg-label-primary">{{ $category->platform?->getTranslation('name', 'en') ?? '—' }}</span>
                            ...
                            <td>
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-end">
                                        <li>
                                            <a href="{{ route('admin.platform-categories.edit', $category) }}" class="dropdown-item">
                                                <i class="icon-base ti tabler-pencil me-2"></i>Edit
                                            </a>
                                        </li>
                                        <li>
                                            <button type="button" class="dropdown-item" wire:click="toggleStatus({{ $category->id }})">
                                        ...
                                        <li>
                                            <button type="button" class="dropdown-item text-danger" wire:click="delete({{ $category->id }})">
                        ...
                        <tr>
                            <td colspan="7">
                                <div class="text-center py-5">
                                    ...
                                    <p class="text-body-secondary mb-4">Start by creating your first platform category.</p>
                                    <a href="{{ route('admin.platform-categories.create') }}" class="btn btn-primary">Add Category</a>
                                </div>
                            </td>
                        </tr>
                    @endforelse
