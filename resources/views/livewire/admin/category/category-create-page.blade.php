                ...
                <div class="card">
                    ...
                    <div class="card-header">
                        ...
                        <small class="text-body-secondary">
                            Enter category information in all supported languages.
                        </small>
                    </div>
                    ...
                    <div class="card-body">
                        ...
                        <ul class="nav nav-tabs mb-4" role="tablist">
                            ...
                            <li class="nav-item">
                                <button id="btn-en" type="button" class="nav-link active"
                                    data-bs-toggle="tab"data-bs-target="#tab-en">
                                    🇺🇸 English
                                </button>
                            </li>
                            ...
                            <div class="tab-pane fade show active" id="tab-en">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea rows="4" wire:model.blur="description.en"
                                        class="form-control @error('description.en') is-invalid @enderror" placeholder="Category description"></textarea>
