    ...
    <div class="card">
        <div class="card-header">
            <div class="d-flex justify-content-between align-items-center flex-wrap gap-3">
                <div>
                    <h4 class="mb-1">{{ __('admin.china_warehouse_orders') }}</h4>
                    <p class="mb-0 text-body-secondary">{{ __('admin.china_warehouse_orders_description') }}</p>
                </div>
            </div>
        </div>
            ...
            <table class="table table-hover align-middle">
                <thead>
                    <tr>
                        ...
                        <th>{{ __('admin.tajikistan_warehouse') }}</th>
                ...
                <tbody>
                    @forelse ($orders as $order)
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('warehouse.china.orders.show', $order) }}" class="btn btn-sm btn-icon btn-text-secondary">
