<div class="container-xxl flex-grow-1 container-p-y">
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <a href="{{ route('admin.china.orders.index') }}" class="btn btn-label-secondary">
            <i class="icon-base ti tabler-arrow-left me-1"></i> {{ __('admin.back_to_orders') }}
        </a>
    </div>

    @include('livewire.admin.warehouse.partials.order-detail-cards', ['order' => $order, 'statusOptions' => $statusOptions, 'showParcelTracking' => true])
