<div class="row">
    ...
    <div class="col-lg-4">
        <div class="card">
            <div class="card-header"><h5 class="mb-0">News image</h5></div>
            <div class="card-body">
                ...
                <div class="mt-3">
                    @if ($image)
                        <img src="{{ $image->temporaryUrl() }}" class="img-fluid rounded border" alt="News preview">
                    @elseif (isset($record))
                        <img src="{{ app(\App\Services\FileManager::class)->url($record->image) }}" class="img-fluid rounded border" alt="News image">
                    @endif
                </div>
                ...
                <button type="submit" class="btn btn-primary w-100 mt-4">
                    ...
                    {{ isset($record) ? 'Update News' : 'Save News' }}
                </button>
                <a href="{{ route('admin.news.index') }}" class="btn btn-label-secondary w-100 mt-2">Cancel</a>
            </div>
        </div>
    </div>
</div>
